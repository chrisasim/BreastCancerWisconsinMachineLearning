...
median = data['Diagnosis'].median(axis=0)
# Η διακύμναση είναι η τυπική απόκλιση στο τετράγωνο.
variance = std*std
...
print("Το σκορ ακρίβεις του συγκεκριμένου μοντέλου μηχανικής μάθησης είναι:")
